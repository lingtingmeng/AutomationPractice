...
public class C5485_quickTradeBtcLtc extends WebDriverBase{
	...
	{		
		KSU.testMsgOut("Test Case C5485: Dashboard: Quick Trade – BTC/LTC");
		Login.login();
		...
		//LogOut
		Logout.logout();
		KSU.testMsgOut("Test Case C5485 (Done): Dashboard: Quick Trade – BTC/LTC");
		//Thread.sleep(3000);
	}
