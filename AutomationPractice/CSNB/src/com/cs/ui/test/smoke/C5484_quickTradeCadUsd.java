...
public class C5484_quickTradeCadUsd extends WebDriverBase{
	...
	{		
		KSU.testMsgOut("Test Case C5484: Dashboard: Quick Trade – CAD/USD");
		Login.login();
		...
		//LogOut
		Logout.logout();
		KSU.testMsgOut("Test Case C5484 (Done): Dashboard: Quick Trade – CAD/USD");
		//Thread.sleep(3000);
	}
