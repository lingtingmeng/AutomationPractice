...
public class C5518_UsdLtc_100Percent extends WebDriverBase{
	 ...
	 * @throws Exception
	 */
	public void quickTradeUsdLTC_100Percent() throws Exception
	{		
		
		DecimalFormat df = new DecimalFormat("###.##");
		
		KSU.testMsgOut("Test Case C5518: Dashboard: Quick Trade – USD/LTC (100%)");
		Login.login();
		...
		//LogOut
		Logout.logout();
		KSU.testMsgOut("Test Case C5518 (DONE): Dashboard: Quick Trade – USD/LTC (100%)");
		//Thread.sleep(3000);
	}
