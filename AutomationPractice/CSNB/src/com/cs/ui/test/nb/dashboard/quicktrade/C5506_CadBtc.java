...
public class C5506_CadBtc extends WebDriverBase{
	...
	{		
		KSU.testMsgOut("Test Case C5506: Dashboard: Quick Trade – CAD/BTC");
		Login.login();
		...
		//LogOut
		Logout.logout();
		KSU.testMsgOut("Test Case C5506 (Done): Dashboard: Quick Trade – CAD/BTC");
		//Thread.sleep(3000);
	}
